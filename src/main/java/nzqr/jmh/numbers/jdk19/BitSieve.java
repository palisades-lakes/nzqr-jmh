...
class BitSieve {
     ...
     * constructor, BitSieve(BigIntegerJDK base, int searchLen).  The length
     ...
     * be even.
     */
    BitSieve(BigIntegerJDK base, int searchLen) {
        /*
     ...
     */
    BigIntegerJDK retrieve(BigIntegerJDK initValue, int certainty, java.util.Random random) {
        ...
        for (int i=0; i<bits.length; i++) {
            ...
            for (int j=0; j<64; j++) {
                if ((nextLong & 1) == 1) {
                    BigIntegerJDK candidate = initValue.add(
                                           BigIntegerJDK.valueOf(offset));
